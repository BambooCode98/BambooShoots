    ...
    <>
      ...
      <div className='relative w-full flex justify-center overflow-auto'>
        <div className=''>
          ...
          <button onClick={() => signOut({callbackUrl: 'https://bamboo-shoots.vercel.app'})} className='hover:md:scale-105 border-2 border-black m-3 p-3 duration-300 bg-gray-800 text-green-400 font-bold rounded-lg w-[120px] fixed z-40 bottom-0 right-0 cursor-pointer'>Sign Out</button>
