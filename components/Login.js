  ...
  return (
    <>
      <Layout>
        ...
        <button onClick={() => signIn(undefined, {callbackUrl: 'http://localhost:3000/account'})} className='text-4xl font-bold select-none p-2 mt-16 rounded-md cursor-pointer bg-green-700/[0.85] border-solid border-t-4 border-4 border-green-900 md:hover:scale-105'>{loggingIn ? 'Login' : 'Register'}</button>
